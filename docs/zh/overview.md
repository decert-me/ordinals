...
NFT的精彩总结](https://mirror.xyz/chainleft.eth/MzPWRsesC9mQflxlLo-N29oF4iwCgX3lacrvaG9Kjko)
...
将比特币权益证明Proof-of-stake添加的提案](https://bitcointalk.org/index.php?topic=102355.0). 这不是资产方案，但确实使用了序数算法，并且已实施但从未部署
过。
...
2012 年 10 月 8 日，jl2012 在[同一论坛上发布了一个方案](https://bitcointalk.org/index.php?topic=117224.0) 该方案使用十进制表示法并具有序数的所有重要属
性。 该计划进行了讨论，但从未实施。
